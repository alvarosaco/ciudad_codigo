...
// PERSONAS
int numeroMaximoPersonas=1000; //Numero de personas que se crearán. Las que se mueran, volverán a nacer
...
float gpsLongitud = 37.88817510;
float gpsLatitud =  -4.77938350;
